Ebid33::Application.configure do
  ...
  config.assets.precompile += %w(print.css fancybox/jquery.fancybox-1.3.4.css fancybox/jquery.mousewheel-3.0.4.pack.js fancybox/jquery.fancybox-1.3.4.pack.js rails.validations.js)
